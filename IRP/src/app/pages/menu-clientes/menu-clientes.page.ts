    ...
    if(this.clientes.clientesArray[i].select === true){
      ...
      if ( duplicate >= 0 ){
        ...
        this.clientes.clientesArray.splice(duplicate, 1);
         ...
         this.map.crearMapa(this.mapa, [{nombre:'NOMBRE',id:'IdCliente',arreglo:this.clientes.rutasClientes},{nombre:'NOMBRE',id:'IdCliente',arreglo:this.clientes.nuevosClientes}], false, false);
