...
export class PlanificacionRutasService {
  ...
  getURL(api: string, provincia: string, canton: string, distrito: string, id: string) {
    ...
    let URL = this.configuracionesService.company.preURL + test + this.configuracionesService.company.postURL + api + environment.provinciaID + provincia + environment.cantonID + canton + environment.distritoID + distrito + id;
  ...
  getIRPURLNormal(api: string, id: string) {
    ...
    const URL =  this.configuracionesService.company.preURL  + test +   this.configuracionesService.company.postURL + api + id;
    this.configuracionesService.api = URL;
  ...
  private getClientes(provincia, canton, distrito) {
    ...
    const URL = this.getURL(environment.clientesURL, provincia, canton, distrito, '');
