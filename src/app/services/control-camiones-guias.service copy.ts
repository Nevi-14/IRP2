...
retornarHora(fecha:Date, duracion){
...
let minutes = fecha.getMinutes() +20 + duracion;
...
if(increaseTime > 1){
  ...
  console.log('reminder', reminder, 'minutes', minutes, 'hours',hours, 'newHours',newHours, 'sum', Number(increaseTime.toFixed(0)))
}
...
console.log('date', date,'hours',hours,'minutes', minutes, 'seconds', seconds, 'miliseconds', miliseconds, 'duracion', duracion)
...
let HoraFin = new Date(Fecha  +' '+ guia.camion.HoraInicio.substring(0,2)+':20'+':00');
  ...
  /**
   *     this.rutero[m].orden_visita = o
      this.rutero[m].HoraInicio =  o === 1 ? HoraInicio : this.retornarHora(this.rutero[o-1].HoraInicio)
      this.rutero[m].HoraFin = o === 1  ?  HoraFin  : this.retornarHora(this.rutero[o-1].HoraFin);
      console.log('ordenamiento tiempo', this.rutero[o-1], HoraInicio, HoraFin, Fecha, guia , Fecha +' '+  guia.camion.HoraInicio+':00' )
   */
/***
 *       this.rutero[m].HoraInicio = o
      this.rutero[m].HoraFin = o
 */
